...
const SelectedCourses = ({selectedCourses, hours, remainingTime, totalPrice}) => {
    ...
    return (
        <div className="md:w-3/12 md:ml-8">
            <div className="bg-white p-8 rounded-lg">
                <h3 className="text-xl font-black mb-4">Credit Hour Remaining: <span className="text-sky-500">{remainingTime}</span> hr</h3>
                <hr />
                <h2 className="text-xl font-bold my-6">Course Name</h2>
                 ...
                 <hr />
                <h3 className="text-xl text-gray-400 font-bold my-4">Total Credit Hour: <span className="text-red-500">{hours}</span></h3>
                 <hr />
